  ...
  return (
    <div className="text-center mx-10 mb-20 ">
      <div className="max-w-md mx-auto bg-white my-10">
        ...
        <div className="p-6">
          <h1 className="font-black text-xl mb-4 text-center">
            {" "}
            Our Training Program{" "}
          </h1>
          <p className="text-gray-700 text-center">
            We are passionate about technology and believe in the power of
            software to transform the world. Our internship program is just one
            of the ways in which we are investing in the future of the industry.
          </p>
        </div>
      </div>
      <div className="flex flex-row flex-wrap justify-center gap-6">
        {WebProduct?.map((test) => (
          <div
            key={test.id}
            className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 p-2 rounded border"
          >
            <a href="https://docs.google.com/forms/d/e/1FAIpQLSdLShCxB1XXzmjdutreGIPECbvpMUcMccxHsWIr65Ly11hf0A/viewform?vc=0&c=0&w=1&flr=0">
              <img
                src={test.image_url}
                alt="Laptop"
                className="h-[200px] w-full rounded-t-md object-cover border-1 border-slate-200 drop-shadow-md"
              />
            </a>
