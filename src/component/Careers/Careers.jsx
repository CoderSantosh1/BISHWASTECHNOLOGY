  ...
  return (
    <div>
      <div className="flex flex-col lg:flex-row bg-gray-200 text-center mt-20 drop-shadow-xl">
        <div className="lg:w-1/2 rounded-lg overflow-hidden">
          <img
            className="w-full lg:max-w-screen-sm mx-auto mt-10    rounded-md drop-shadow-xl
        ...
        <div className="lg:w-1/2 flex flex-col justify-center p-8">
          ...
          <p className="text-2xl lg:text-3xl text-gray-500 mb-8">
            BISHWAS TECHNOLOGY has decided to keep their services overview lean
            and make their solutions & success stories a bit more robust so
            users can see for themselves how companies like their own can find
