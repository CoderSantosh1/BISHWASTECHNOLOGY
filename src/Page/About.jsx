...
const About = () => {
  return (
    <div className=" relative">
      ...
      <div className="flex flex-col lg:flex-row bg-gray-200 text-center mt-20 drop-shadow-xl">
        ...
        <div className="lg:w-1/2 flex flex-col justify-center p-8">
          ...
          <p className="text-2xl lg:text-3xl text-gray-500 mb-8">
            Welcome to BISHWAS TECHNOLOGY, where Make the all student for the
            better envoriment for the IT Hubbs, we have been dedicated to achive
            your next Goal. Let's Meet our Team.
          </p>
          <button
      ...
      <div className="p-4 mt-20 text-center">
        <h1 className="font-bold mb-4 text-balance text-6xl">Get to know us</h1>
      ...
      <div className="mx-auto max-w-7xl px-2 lg:px-0  my-10">
        <div className="mx-auto max-w-3xl md:text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-gray-600 md:text-xl">
            "Our team is made up of experienced and dedicated professionals who
            are passionate about our work. We are committed to providing our
            clients with the best possible service and support. We believe that
            our team is our greatest asset, and we are proud of the work that
            they do."
          </p>
        </div>
          ...
          {team.map((item) => (
            ...
            transition delay-150 duration-300 ease-in-out
              ...
              <div className="p-4">
                ...
                <h6 className="mt-3 font-medium">{item.position}</h6>
                <p className="mt-3 text-sm text-gray-600">{item.bio}</p>
